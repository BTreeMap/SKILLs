...
<full-directives>
  ...
  <validation-checklist>
    ...
    <item>Type is explicitly chosen from `<allowed-types>`.</item>
    ...
    <item>Output contains zero conversational filler per the `<output-contract>`.</item>
  </validation-checklist>
</full-directives>
