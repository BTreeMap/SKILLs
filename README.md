...
| [aesthete](aesthete/SKILL.md) | Designs, builds, reviews, and rehabilitates interfaces with an HCI eye - design read, dials, laws of taste, interaction kernel - with verbs, surface profiles, craft references, and a mechanical ship gate. |
