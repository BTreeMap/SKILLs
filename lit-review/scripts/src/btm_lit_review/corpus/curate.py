...
from btm_lit_review.findings.notebook import load_notebook, next_id
from btm_lit_review.report.views import unextracted
...
class Decision(Model):
    ...
    def _sets_only_real_values(self) -> Decision:
        ...
        if self.status is Status.EXCLUDED and not collapsed(self.reason):
            problems.append(
